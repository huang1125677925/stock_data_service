...
class IndustrySector(models.Model):
    ...
    latest_price = models.FloatField(null=True, blank=True, verbose_name='最新价')
    change_amount = models.FloatField(null=True, blank=True, verbose_name='涨跌额')
    change_percent = models.FloatField(null=True, blank=True, verbose_name='涨跌幅')
    total_market_value = models.BigIntegerField(null=True, blank=True, verbose_name='总市值')
    ...
    leading_stock = models.CharField(max_length=50, null=True, blank=True, verbose_name='领涨股票')
    leading_stock_change_percent = models.FloatField(null=True, blank=True, verbose_name='领涨股票涨跌幅')
