...
class StockMarketFundFlow(models.Model):
    ...
    功能：存储股票市场的资金流向数据，包括主力、大单、中单、小单、超大单的净流入情况
    参数：
        - date: 日期
        - main_net_inflow_amount: 主力净流入-净额
        - small_net_inflow_amount: 小单净流入-净额
        - medium_net_inflow_amount: 中单净流入-净额
        - large_net_inflow_amount: 大单净流入-净额
        - super_large_net_inflow_amount: 超大单净流入-净额
        ...
        - shanghai_close_price: 上证-收盘价
        - shanghai_change_rate: 上证-涨跌幅
        - shenzhen_close_price: 深证-收盘价
        - shenzhen_change_rate: 深证-涨跌幅
    返回值：大盘资金流数据记录
    事件：创建、更新时自动记录时间戳
    """
    date = models.DateField(unique=True, verbose_name="日期", help_text="数据日期")
    
    # 净流入金额（单位：万元）
    main_net_inflow_amount = models.DecimalField(
        max_digits=15, 
        decimal_places=2, 
        null=True, 
        blank=True,
    ...
    small_net_inflow_amount = models.DecimalField(
        max_digits=15, 
        decimal_places=2, 
        null=True, 
        blank=True,
    ...
    medium_net_inflow_amount = models.DecimalField(
        max_digits=15, 
        decimal_places=2, 
        null=True, 
        blank=True,
    ...
    large_net_inflow_amount = models.DecimalField(
        max_digits=15, 
        decimal_places=2, 
        null=True, 
        blank=True,
    ...
    super_large_net_inflow_amount = models.DecimalField(
        max_digits=15, 
        decimal_places=2, 
        null=True, 
        blank=True,
    ...
    small_net_inflow_ratio = models.DecimalField(
        max_digits=8, 
        decimal_places=4, 
        null=True, 
        blank=True,
    ...
    medium_net_inflow_ratio = models.DecimalField(
        max_digits=8, 
        decimal_places=4, 
        null=True, 
        blank=True,
    ...
    large_net_inflow_ratio = models.DecimalField(
        max_digits=8, 
        decimal_places=4, 
        null=True, 
        blank=True,
    ...
    super_large_net_inflow_ratio = models.DecimalField(
        max_digits=8, 
        decimal_places=4, 
        null=True, 
        blank=True,
    ...
    # 指数数据
    shanghai_close_price = models.DecimalField(
        max_digits=10, 
        decimal_places=2, 
        null=True, 
        blank=True,
    ...
    shanghai_change_rate = models.DecimalField(
        max_digits=8, 
        decimal_places=4, 
        null=True, 
        blank=True,
    ...
    shenzhen_close_price = models.DecimalField(
        max_digits=10, 
        decimal_places=2, 
        null=True, 
        blank=True,
    ...
    shenzhen_change_rate = models.DecimalField(
        max_digits=8, 
        decimal_places=4, 
        null=True, 
        blank=True,
