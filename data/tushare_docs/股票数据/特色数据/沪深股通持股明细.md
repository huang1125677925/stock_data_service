...
源链接: https://tushare.pro/document/2?doc_id=188
...
<h2 id="沪深港股通持股明细">沪深港股通持股明细</h2>
<p>接口：hk_hold，可以通过<a href="https://tushare.pro/webclient/"><strong>数据工具</strong></a>调试和查看数据。<br/>描述：获取沪深港股通持股明细，数据来源港交所。<br/>限量：单次最多提取3800条记录，可循环调取，总量不限制<br/>积分：用户积120积分可调取试用，2000积分可正常使用，单位分钟有流控，积分越高流量越大，请自行提高积分，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
<p>说明：交易所于从2024年8月20开始停止发布北向资金数据</p>
<br/>
<br/>
...
<td>str</td>
<td>N</td>
<td>类型：SH沪股通（北向）SZ深股通（北向）HK港股通（南向持股）</td>
</tr>
</tbody></table>
<br/>
<br/>
...
<td>float</td>
<td>Y</td>
<td>持股占比（%），占已发行股份百分比</td>
</tr>
<tr>
<td>exchange</td>
<td>str</td>
<td>Y</td>
<td>类型：SH沪股通SZ深股通HK港股通</td>
</tr>
</tbody></table>
<br/>
<br/>
...
<pre><code>      code  trade_date    ts_code      name        vol  ratio exchange
