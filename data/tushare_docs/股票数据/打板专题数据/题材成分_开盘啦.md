...
源链接: https://tushare.pro/document/2?doc_id=351
...
<h2 id="开盘啦题材成分">开盘啦题材成分</h2>
<hr/>
<p>接口：kpl_concept_cons<br/>描述：获取开盘啦概念题材的成分股<br/>限量：单次最大3000条，可根据代码和日期循环获取全部数据<br/>积分：5000积分可提取数据，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
...
<pre><code>        ts_code      name     ts_name con_code trade_date
