...
源链接: https://tushare.pro/document/2?doc_id=107
...
<h2 id="龙虎榜机构明细">龙虎榜机构明细</h2>
<hr/>
<p>接口：top_inst<br/>描述：龙虎榜机构成交明细<br/>限量：单次请求最大返回10000行数据，可根据参数循环获取全部历史<br/>积分：用户需要至少2000积分才可以调取，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
<br/>
<br/>
...
<pre><code>   trade_date          buy         sell side                   reason
