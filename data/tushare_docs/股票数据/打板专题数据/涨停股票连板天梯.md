...
源链接: https://tushare.pro/document/2?doc_id=356
...
<h2 id="连板天梯">连板天梯</h2>
<hr/>
<p>接口：limit_step<br/>描述：获取每天连板个数晋级的股票，可以分析出每天连续涨停进阶个数，判断强势热度<br/>限量：单次最大2000行数据，可根据股票代码或者日期循环提取全部<br/>积分：8000积分以上每分钟500次，每天总量不限制，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
<br/>
<br/>
...
<pre><code>    ts_code        name trade_date nums
