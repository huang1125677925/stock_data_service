...
源链接: https://tushare.pro/document/2?doc_id=145
...
<h2 id="月线行情">月线行情</h2>
<hr/>
<p>接口：monthly<br/>描述：获取A股月线数据<br/>限量：单次最大4500行，总量不限制<br/>积分：用户需要至少2000积分才可以调取，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a></p>
