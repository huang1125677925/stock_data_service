...
源链接: https://tushare.pro/document/2?doc_id=365
...
<h2 id="股票周月线行情复权--每日更新">股票周/月线行情(复权--每日更新)</h2>
<hr/>
<p>接口：stk_week_month_adj<br/>描述：股票周/月线行情(复权--每日更新)<br/>限量：单次最大6000,可使用交易日期循环提取，总量不限制<br/>积分：用户需要至少2000积分才可以调取，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a></p>
<br/>
<br/>
...
<pre><code>       ts_code  trade_date  freq   open   high    low  close  pre_close  open_qfq  high_qfq  low_qfq  close_qfq  open_hfq  high_hfq  low_hfq  close_hfq         vol      amount  change  pct_chg
