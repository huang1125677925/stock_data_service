...
源链接: https://tushare.pro/document/2?doc_id=49
...
<h2 id="港股通十大成交股">港股通十大成交股</h2>
<hr/>
<p>接口：ggt_top10<br/>描述：获取港股通每日成交数据，其中包括沪市、深市详细数据，每天18~20点之间完成当日更新</p>
...
<pre><code>   trade_date ts_code       name   close   p_change  rank   market_type  \
