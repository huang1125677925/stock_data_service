...
源链接: https://tushare.pro/document/2?doc_id=262
...
<h2 id="股票历史列表（历史每天股票列表）">股票历史列表（历史每天股票列表）</h2>
<hr/>
<p>接口：bak_basic<br/>描述：获取备用基础列表，数据从2016年开始<br/>限量：单次最大7000条，可以根据日期参数循环获取历史，正式权限需要5000积分。</p>
...
<pre><code> trade_date    ts_code  name industry       pe
