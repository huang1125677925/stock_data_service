...
源链接: https://tushare.pro/document/2?doc_id=123
...
<h2 id="ipo-">IPO新股列表</h2>
<hr/>
<p>接口：new_share<br/>描述：获取新股上市列表数据<br/>限量：单次最大2000条，总量不限制<br/>积分：用户需要至少120积分才可以调取，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
...
<pre><code>  ts_code       sub_code  name  ipo_date    issue_date   amount  market_amount  \
...
12  16.07  22.99          6.90  37.145    0.12  </code></pre>
</div>
