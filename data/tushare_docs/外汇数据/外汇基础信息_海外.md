...
源链接: https://tushare.pro/document/2?doc_id=178
...
<h2 id="外汇基础信息（海外）">外汇基础信息（海外）</h2>
<hr/>
<p>接口：fx_obasic<br/>描述：获取海外外汇基础信息，目前只有FXCM交易商的数据<br/>数量：单次可提取全部数据<br/>积分：用户需要至少2000积分才可以调取，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
<br/>
<br/>
...
<pre><code>        ts_code                  name     min_unit  max_unit  pip  pip_cost
