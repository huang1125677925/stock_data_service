...
源链接: https://tushare.pro/document/2?doc_id=304
...
<h2 id="港股分钟行情">港股分钟行情</h2>
<hr/>
<p>接口：hk_mins<br/>描述：港股分钟数据，支持1min/5min/15min/30min/60min行情，提供Python SDK和 http Restful API两种方式<br/>限量：单次最大8000行数据，可以通过股票代码和日期循环获取<br/>权限：120积分可以调取2次接口查看数据，正式权限请参阅 <u><a href="https://tushare.pro/document/1?doc_id=290">权限说明</a> </u> 。</p>
<br/>
<br/>
...
<pre><code>  ts_code                trade_time  open  close   high    low       vol      amount
