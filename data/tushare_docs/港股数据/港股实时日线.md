...
源链接: https://tushare.pro/document/2?doc_id=383
...
<h2 id="港股实时日线">港股实时日线</h2>
<hr/>
<p>接口：rt_hk_k<br/>描述：获取港股实时日k线行情，支持按股票代码及股票代码通配符一次性提取全部股票实时日k线行情<br/>限量：单次最大可提取5000条数据<br/>积分：本接口是单独开权限的数据，单独申请权限请参考<a href="https://tushare.pro/document/1?doc_id=290">权限列表</a></p>
<br/>
<br/>
...
<pre><code>       ts_code  pre_close  close   high   open    low            vol       amount
