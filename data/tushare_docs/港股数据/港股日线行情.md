...
源链接: https://tushare.pro/document/2?doc_id=192
...
<h2 id="港股行情">港股行情</h2>
<hr/>
<p>接口：hk_daily，可以通过<a href="https://tushare.pro/webclient/"><strong>数据工具</strong></a>调试和查看数据。<br/>描述：获取港股每日增量和历史行情，每日18点左右更新当日数据<br/>限量：单次最大提取5000行记录，可多次提取，总量不限制<br/>积分：本接口单独开权限，具体请参阅<a href="https://tushare.pro/document/1?doc_id=290">权限说明</a> </p>
<br/>
<br/>
...
<pre><code>      ts_code trade_date   open  ...  pct_chg         vol        amount
