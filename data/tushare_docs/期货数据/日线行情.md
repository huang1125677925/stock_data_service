...
源链接: https://tushare.pro/document/2?doc_id=138
...
<h2 id="期货日线行情">期货日线行情</h2>
<hr/>
<p>接口：fut_daily，可以通过<a href="https://tushare.pro/webclient/"><strong>数据工具</strong></a>调试和查看数据。<br/>描述：期货日线行情数据<br/>限量：单次最大2000条，总量不限制<br/>积分：用户需要至少2000积分才可以调取，未来可能调整积分，请尽量多的积累积分。具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
...
<pre><code>     ts_code    trade_date  pre_close  pre_settle     open     high      low  \
