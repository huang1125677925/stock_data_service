...
源链接: https://tushare.pro/document/2?doc_id=141
...
<h2 id="结算参数">结算参数</h2>
<hr/>
<p>接口：fut_settle<br/>描述：获取每日结算参数数据，包括交易和交割费率等<br/>限量：单次最大返回1600行数据，可根据日期循环，总量不限制<br/>积分：用户需要至少2000积分才可以调取，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
...
<pre><code>    ts_code     trade_date    settle  trading_fee_rate  trading_fee  \
