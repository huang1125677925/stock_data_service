...
源链接: https://tushare.pro/document/2?doc_id=140
...
<h2 id="仓单日报">仓单日报</h2>
<hr/>
<p>接口：fut_wsr<br/>描述：获取仓单日报数据，了解各仓库/厂库的仓单变化<br/>限量：单次最大1000，总量不限制<br/>积分：用户需要至少2000积分才可以调取，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
...
<pre><code>     trade_date symbol fut_name    warehouse  pre_vol   vol  vol_chg unit
