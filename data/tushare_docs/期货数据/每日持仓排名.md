...
源链接: https://tushare.pro/document/2?doc_id=139
...
<h2 id="每日成交持仓排名">每日成交持仓排名</h2>
<hr/>
<p>接口：fut_holding<br/>描述：获取每日成交持仓排名数据<br/>限量：单次最大2000，总量不限制<br/>积分：用户需要至少2000积分才可以调取，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
...
<pre><code>     trade_date symbol  broker       vol    vol_chg  long_hld    long_chg  \
