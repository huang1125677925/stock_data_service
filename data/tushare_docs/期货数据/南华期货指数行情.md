...
源链接: https://tushare.pro/document/2?doc_id=155
...
<h2 id="南华期货指数日线行情">南华期货指数日线行情</h2>
<hr/>
<p>接口：index_daily<br/>描述：获取南华指数每日行情，指数行情也可以通过<a href="https://tushare.pro/document/2?doc_id=109"><strong>通用行情接口</strong></a>获取数据．<br/>权限：用户需要累积2000积分才可以调取，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
<br/>
<br/>
...
<pre><code>    ts_code trade_date     close      open      high       low  pre_close  \
