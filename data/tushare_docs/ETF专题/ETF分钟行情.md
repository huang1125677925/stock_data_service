...
源链接: https://tushare.pro/document/2?doc_id=387
...
<h2 id="etf历史分钟行情">ETF历史分钟行情</h2>
<hr/>
<p>接口：stk_mins<br/>描述：获取ETF分钟数据，支持1min/5min/15min/30min/60min行情，提供Python SDK和 http Restful API两种方式<br/>限量：单次最大8000行数据，可以通过股票代码和时间循环获取，本接口可以提供超过10年ETF历史分钟数据<br/>权限：正式权限请参阅 <u><a href="https://tushare.pro/document/1?doc_id=290">权限说明</a> </u> </p>
<br/>
<br/>
...
<pre><code>       ts_code           trade_time  close   open   high    low        vol      amount
