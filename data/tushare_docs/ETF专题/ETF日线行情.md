...
源链接: https://tushare.pro/document/2?doc_id=127
...
<h2 id="etf日线行情">ETF日线行情</h2>
<hr/>
<p>接口：fund_daily<br/>描述：获取ETF行情每日收盘后成交数据，历史超过10年<br/>限量：单次最大2000行记录，可以根据ETF代码和日期循环获取历史，总量不限制<br/>积分：需要至少2000积分才可以调取，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
<br/>
<br/>
...
<pre><code>   trade_date   open   high    low  close         vol       amount
