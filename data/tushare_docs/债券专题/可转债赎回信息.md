...
源链接: https://tushare.pro/document/2?doc_id=269
...
<h2 id="可转债赎回信息">可转债赎回信息</h2>
<hr/>
<p>接口：cb_call，可以通过<a href="https://tushare.pro/webclient/"><strong>数据工具</strong></a>调试和查看数据。<br/>描述：获取可转债到期赎回、强制赎回等信息。数据来源于公开披露渠道，供个人和机构研究使用，请不要用于数据商业目的。<br/>限量：单次最大2000条数据，可以根据日期循环提取，本接口需5000积分。</p>
...
<pre><code>    ts_code call_type is_call  ann_date call_date call_price
