...
源链接: https://tushare.pro/document/2?doc_id=272
...
<h2 id="大宗交易明细">大宗交易明细</h2>
<hr/>
<p>接口：bond_blk_detail<br/>权限：用户满5000积分有数据权限，单次最大1000条，可根据日期循环提取，总量不限制<br/>描述：获取沪深交易所债券大宗交易数据，可以通过<a href="https://tushare.pro/webclient/"><strong>数据工具</strong></a>调试和查看数据。</p>
<p><strong>注：本接口目前只有深交所的大宗交易明细，上交所明细已经包含在大宗交易接口里，未单独罗列。</strong></p>
<br/>
<br/>
...
<pre><code>     trade_date  ts_code    name     price     vol    amount                        buy_dp          sell_dp
...
999   20210924  137942.SZ   美满03次  103.61   30.00   3108.30  中国国际金融股份有限公司上海黄浦区湖滨路证券营业部</code></pre>
</div>
