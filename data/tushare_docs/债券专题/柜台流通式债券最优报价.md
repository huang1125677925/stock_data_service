...
源链接: https://tushare.pro/document/2?doc_id=323
...
<h2 id="柜台流通式债券最优报价">柜台流通式债券最优报价</h2>
<hr/>
<p>接口：bc_bestotcqt<br/>描述：柜台流通式债券最优报价<br/>限量：单次最大2000，可多次提取，总量不限制<br/>积分：用户需要至少500积分可以试用调取，2000积分以上频次相对较高，积分越多权限越大，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
...
<pre><code class="language-python">pro = ts.pro_api(your token)
#获取柜台流通式债券最优报价
...
<pre><code>    trade_date ts_code name remain_maturity best_buy_bank best_buy_yield best_sell_bank best_sell_yield
