...
源链接: https://tushare.pro/document/2?doc_id=116
...
<h2 id="-">影院每日票房</h2>
<hr/>
<p>接口：bo_cinema<br/>描述：获取每日各影院的票房数据<br/>数据历史： 数据从2018年9月开始，更多历史数据正在补充<br/>数据权限：用户需要至少500积分才可以调取，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
...
df = pro.bo_cinema(date='20181014')</code></pre>
<p><strong>数据示例</strong></p>
<pre><code>        date        c_name                aud_count  att_ratio  day_amount  \
...
18  20181014    郑州奥斯卡熙地港国际影城   3286      27.60   124663.00  </code></pre>
</div>
