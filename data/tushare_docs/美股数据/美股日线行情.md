...
源链接: https://tushare.pro/document/2?doc_id=254
...
<h2 id="美股行情">美股行情</h2>
<hr/>
<p>接口：us_daily<br/>描述：获取美股行情（未复权），包括全部股票全历史行情，以及重要的市场和估值指标<br/>限量：单次最大6000行数据，可根据日期参数循环提取，开通正式权限后也可支持分页提取全部历史<br/>要求：120积分可以试用查看数据，开通正式权限请参考<a href="https://tushare.pro/document/1?doc_id=290">权限说明文档</a>。</p>
<br/>
<br/>
...
<pre><code>    ts_code trade_date   close    open    high     low pre_close pct_change       vol              amount    vwap
