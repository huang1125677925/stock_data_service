...
源链接: https://tushare.pro/document/2?doc_id=373
...
<h2 id="中信行业成分">中信行业成分</h2>
<hr/>
<p>接口：ci_index_member<br/>描述：按三级分类提取中信行业成分，可提供某个分类的所有成分，也可按股票代码提取所属分类，参数灵活<br/>限量：单次最大5000行，总量不限制<br/>权限：用户需5000积分可调取，积分获取方法请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
<br/>
<br/>
...
<pre><code>        l2_code     l1_name  ts_code       name
