...
源链接: https://tushare.pro/document/2?doc_id=327
...
<h2 id="申万行业日线行情">申万行业日线行情</h2>
<hr/>
<p>接口：sw_daily<br/>描述：获取申万行业日线行情（默认是申万2021版行情）<br/>限量：单次最大4000行数据，可通过指数代码和日期参数循环提取，5000积分可调取</p>
...
<pre><code>        ts_code      name      open     close         vol      pe    pb
