...
源链接: https://tushare.pro/document/2?doc_id=211
...
<h2 id="国际指数">国际指数</h2>
<hr/>
<p>接口：index_global，可以通过<a href="https://tushare.pro/webclient/"><strong>数据工具</strong></a>调试和查看数据。<br/>描述：获取国际主要指数日线行情<br/>限量：单次最大提取4000行情数据，可循环获取，总量不限制<br/>积分：用户积6000积分可调取，积分越高频次越高，请自行提高积分，具体请参阅<a href="https://tushare.pro/document/1?doc_id=13">积分获取办法</a> </p>
<br/>
<br/>
...
<pre><code>     trade_date    open     close    high    low       pre_close  change  \
