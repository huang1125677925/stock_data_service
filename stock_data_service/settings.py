...
CRONJOBS = [
    ...
    ('46 0 * * 1-5', 'stock_strategy.index_analysis.actual_rise_ratio_5d_service.update_actual_rise_ratio_5d', f'>> {BASE_DIR}/logs/update_actual_rise_ratio_5d.log 2>&1'),  # 每周一至周五16:00-22:00更新5日实际上涨比例
]
